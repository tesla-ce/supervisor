...
urlpatterns = [
    ...
    path('deploy/tesla/worker', deploy.APIDeployAPIWorker.as_view(), name='setup_api_deploy_tesla_tesla_worker'),
    ...
    path('check/tesla/worker', check.APICheckAPIWorker.as_view(), name='setup_api_check_tesla_worker'),
